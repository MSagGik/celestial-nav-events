...
import celestialnavigationevents.model.events.lunar.LunarAbsoluteEventDay
import celestialnavigationevents.model.events.lunar.LunarEventDay
import celestialnavigationevents.model.events.lunar.LunarRelativeEventDay
 ...
 *
 * This implementation applies a predefined [StandardProfiles.MOONRISE_OFFSET] to correct the visual horizon for
...
internal class LunarCalculatorImpl : LunarEventsCalculator {
     ...
     *
     * Applies a visual correction constant ([StandardProfiles.MOONRISE_OFFSET]) to adjust for atmospheric refraction.
