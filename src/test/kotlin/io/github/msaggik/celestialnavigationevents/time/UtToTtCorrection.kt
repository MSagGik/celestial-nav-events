...
import io.github.msaggik.celestialnavigationevents.common.QuantumTest
...
internal class UtToTtCorrection {
    ...
    @QuantumTest fun `estimate year 1960_999`() {
    ...
    @QuantumTest fun `estimate year 1985_999`() {
    ...
    @QuantumTest fun `estimate throws for year above 3000`() {
