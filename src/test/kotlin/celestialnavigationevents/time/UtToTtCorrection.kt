...
package celestialnavigationevents.time
...
internal class UtToTtCorrection {
    ...
    @CelestialNavigationEventsTest
    fun `estimate throws for year above 3000`() {
